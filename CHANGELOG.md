...
### Changed
- Rename the **Ask aside** action to **Side question**, clarify starting-context and related-file labels, and keep primary side-question buttons readable on hover.
