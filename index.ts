...
function findClosingUnescapedDelimiter(text: string, startIndex: number, delimiter: string): number {
...
function preserveLiteralLatexCommandsInMarkdownSegment(markdown: string): string {
...
function preserveLiteralLatexCommandsInMarkdown(markdown: string): string {
